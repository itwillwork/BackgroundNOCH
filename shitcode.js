...
CollectionBackgroundItem.prototype.holdIfGetOut = function ( itemBackground ) {
...
CollectionBackgroundItem.prototype.deleteNode = function (layerIndex, itemIndex) {
...
BackgroundItem.prototype.isVisible = function (positionOnCanvas) {
    ...
    //TODO разобраться с оптимизацией, не получлось вернуть размер картинки
    /*
